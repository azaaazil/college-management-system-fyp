...
const StudentLogin = () => {
  ...
  return (
    <div className="bg-[#242424] h-screen w-screen flex items-center justify-center"
   style={{
        backgroundImage: `url("/studentbg.png")`,   //Background Pic hai stdnt login ki
      ...
      <div className="grid grid-cols-2">
        ...
        <form
          ...
          <div className="space-y-1">
            <p className="text-[#CCCCCC] font-bold text-sm">Username</p>
          ...
          <div className="space-y-1">
            <p className="text-[#CCCCCC] font-bold text-sm">Password</p>
