  ...
  return (
    <div className="flex-[0.8] ml-5 mt-3">
      <div className="space-y-5">
        ...
        <div className=" mr-10 bg-[#1B263B] rounded-xl pt-6 pl-6 h-[30rem]">
          <div className="col-span-3 mr-6">
            <div className={classes.loadingAndError}>
              ...
              {error.noSubjectError && (
                <p className="text-[#CCCCCC] text-2xl font-bold">
                  {error.noSubjectError}
                </p>
              )}
            </div>
            {!loading &&
              ...
              subjects?.length !== 0 && (
                <div className={classes.adminData}>
                  <div className="grid grid-cols-8 text-[#CCCCCC]">
                  ...
                  {attendance?.map((res, idx) => (
                    <div
                      key={idx}
                      className={`${classes.adminDataBody} grid-cols-8 text-[#CCCCCC]`}>
                      <h1
