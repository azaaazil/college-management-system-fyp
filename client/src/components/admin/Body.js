...
const Body = () => {
  ...
  return (
    <div className="flex-[0.8]  absolute right-[10%]  mt-5">
      <div className="space-y-6">
        ...
        <div className="flex flex-col mr-5 space-y-4 overflow-y-hidden">
          <div className="bg-[#1B263B] h-[8rem] rounded-xl shadow-lg grid grid-cols-4 justify-between px-8 items-center space-x-4">
            <div className="flex items-center space-x-4 border-r-2">
              ...
              <div className="flex flex-col text-[#CCCCCC]">
                <h1>Faculty</h1>
                <h2 className="text-2xl text-[#CCCCCC] font-bold">{faculties?.length}</h2>
              </div>
            </div>
            <div className="flex items-center space-x-4 border-r-2">
              <BoyIcon
              ...
              <div className="flex flex-col text-[#CCCCCC]">
                <h1>Student</h1>
                <h2 className="text-2xl text-[#CCCCCC] font-bold">{students?.length}</h2>
              </div>
            </div>
            <div className="flex items-center space-x-4 border-r-2">
              ...
              <div className="flex flex-col text-[#CCCCCC] ">
                <h1>Admin</h1>
                <h2 className="text-2xl text-[#CCCCCC]  font-bold">{admins?.length}</h2>
              </div>
            </div>
            <div className="flex items-center space-x-4 ">
              <MenuBookIcon
                ...
                sx={{ fontSize: 40 }}
              />
              <div className="flex text-[#CCCCCC] flex-col">
                <h1>Department</h1>
                <h2 className="text-2xl font-bold text-[#CCCCCC]">{departments?.length}</h2>
              </div>
            </div>
          </div>
          <div className="flex space-x-4">
            ...
            <div className="bg-white h-[17rem] w-full rounded-xl shadow-lg flex flex-col  pt-3">
              ...
              <div className="mx-4 mt-4  space-y-3 overflow-y-auto h-[12rem] ">
                {!open ? (
