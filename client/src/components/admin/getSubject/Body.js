  ...
  return (
    <div className="flex-[0.8] ml-5 mt-3">
      <div className="space-y-5">
        <div className="flex text-[#CCCCCC] ml-3 items-center space-x-2">
          <MenuBookIcon />
          <h1>All Subjects</h1>
        </div>
        <div className=" mr-10 bg-[#1B263B] grid grid-cols-4 rounded-xl pt-6 pl-6 h-[29.5rem]">
          <form
            className="flex flex-col space-y-2 col-span-1 text-[#CCCCCC]"
          ...
          <div className="col-span-3 mr-6 text-[#CCCCCC]">
