  ...
  return (
    <div className="flex-[0.8] mt-3">
      <div className="space-y-5">
        ...
        <div className=" mr-10 bg-[#1B263B] flex flex-col rounded-xl ">
          <form
            onSubmit={update}
            className="flex flex-col space-y-6 items-center my-8">
            <h1 className="text-3xl font-bold text-[#CCCCCC]">Update Password</h1>
            ...
            <div className="space-y-1">
              <p className="text-[#CCCCCC] font-bold text-sm">
                Confirm Password
              </p>
              <div className="border-2 rounded-lg px-3 flex items-center space-x-3 w-full">
                <input
